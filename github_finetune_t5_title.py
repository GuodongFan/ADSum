...
def read_arguments():
	...
	parser.add_argument("--output_dir", default="./model_github_ft", type=str, required=False,
...
def main(args):
	...
	# data path
	train_filename = args.data_dir + "/" + "/github/train.csv"
	dev_filename = args.data_dir + "/" + "/github/valid.csv"
	test_filename = args.data_dir + "/" + "/github/test.csv"
	...
	if args.do_train:
		...
		#train_examples = random.sample(train_examples, min(100, len(train_examples)))
