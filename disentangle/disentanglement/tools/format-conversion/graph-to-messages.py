...
if __name__ == '__main__':
    ...
    parser.add_argument('--ascii', help="File containing the ascii version of the data",
                        default="data/gitter/Microsoft/TypeScript/content.ascii.txt")
    parser.add_argument('--annotations', help="File containing the graph annotations",
                        default="data/gitter/Microsoft/TypeScript/content.annotation.txt")
    ...
    parser.add_argument('--max-speakers',
                        help="Only print conversations with this many or fewer participants (not counting the channel bot)",
                        type=int)
    parser.add_argument('--min-speakers',
                        help="Only print conversations with this many or more participants (not counting the channel bot)",
                        type=int)
