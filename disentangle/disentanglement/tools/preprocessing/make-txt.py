...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_suffix', default='.ascii.txt', help='Save to files with the suffix added.')
    ...
    for input_filename in args.raw_data:
        if args.output_suffix is not None:
            if input_filename.endswith(".raw.txt"):
                name = input_filename[:-len(".raw.txt")]
            out = open(name + args.output_suffix, 'w')
        data = open(input_filename, encoding='utf-8')
        line = ''
